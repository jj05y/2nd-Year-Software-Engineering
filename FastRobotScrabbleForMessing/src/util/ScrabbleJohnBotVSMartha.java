...
public class ScrabbleJohnBotVSMartha {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		UI ui = new UI();
		JohnBot Bobbot = new JohnBot();
		Bot Marthabot = new Bot();
		...
		players[BOBBOT_ID].setName("John");
	...
	private static double computeAvgTime(Bot bot) {
		double sum = 0;
		try {
