...
public class NorfolkNChance implements Bot {
	...
	public int checkExtensions(Word word, Dictionary dictionary, Board board) {
		...
		if(word.isHorizontal()) {
			if(board.getSqContents(word.getStartRow(), word.getStartColumn()-1)!= Board.EMPTY) {
				prefixIndex=1;
				while(board.getSqContents(word.getStartRow(), word.getStartColumn()-prefixIndex)!= Board.EMPTY) {
					prefixIndex++;
					doPrefix=true;
				}
				do{
			...
			if(board.getSqContents(word.getStartRow(), word.getStartColumn()+word.getLength()+1)!= Board.EMPTY) {
				suffixIndex=0;
				while(board.getSqContents(word.getStartRow(), word.getStartColumn()+word.getLength()+suffixIndex)!= Board.EMPTY) {
					suffixIndex++;
					doSuffix=true;
				}
				do{
			...
			if(board.getSqContents(word.getStartRow()-1, word.getStartColumn())!= Board.EMPTY) {
				prefixIndex=1;
				while(board.getSqContents(word.getStartRow()-prefixIndex, word.getStartColumn())!= Board.EMPTY) {
					prefixIndex++;
					doPrefix=true;
				}
				do{
			...
			if(board.getSqContents(word.getStartRow()+word.getLength()+1, word.getStartColumn())!= Board.EMPTY) {
				suffixIndex=0;
				while(board.getSqContents(word.getStartRow()+word.getLength()+suffixIndex, word.getStartColumn())!= Board.EMPTY) {
					suffixIndex++;
					doSuffix=true;
				}
				do{
