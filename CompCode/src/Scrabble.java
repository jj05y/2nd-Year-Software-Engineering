// TwoBots
// =======
// To run it, create a jar file using Eclipse File->Export->java->jar executeable->name + directory
// Then, run the jar using terminal
// java -jar TwoBots.jar [<bot_name>] [<bot_name>] [-v] [-p]
// need sowpods.txt in the same directory
// [] = optional parameter
// the default bot is AiPlayer which just takes the first move found
// v = verbose 
//
// 
...
import java.io.IOException;
 ...
 public class Scrabble {
	...
	private static String[] BOT_NAMES = {
		...
		"TauTitans","TriForce","yet_itCompiles", "MVPslow"};
